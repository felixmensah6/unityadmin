...
if (jQuery)(function($) {
  ...
  function show(type, message, options) {
    ...
    if (options.closeButton) {
      modal.append('<span class="close alertable-cancel">&times;</span>');
    } else {
      modal.remove('.close');
    }
    ...
    // Watch for cancel
    $('.alertable-cancel').on('click', function() {
      hide(options);
      defer.reject();
    });
  ...
  $.alertable = {
    ...
    defaults: {
      ...
      // Templates
      cancelButton: '<button class="btn btn-default alertable-cancel" type="button">Cancel</button>',
      okButton: '<button class="btn btn-primary alertable-ok" type="submit">OK</button>',
      overlay: '<div class="alertable-overlay"></div>',
      prompt: '<input class="form-control alertable-input" type="text" name="value">',
